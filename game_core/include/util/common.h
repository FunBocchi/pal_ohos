...
#define SDL_FORCE__INLINE __attribute__((always_inline)) static __inline__
#else
...
#else
#define PAL_FORCE_INLINE SDL_FORCE_INLIINE
#endif
 ...
 */
#include "util/pal_config.h"
// 此需要参考SDL库预处理宏，在本项目中应该不会用到
