...
#ifndef pal_ohos_AUDIO_H
#define pal_ohos_AUDIO_H

#include "engine/audio/players.h"
...
public:
    ...
    void playMusic(int music_num, bool loop, float fade_time);
    void playSound(int sound_num);
    void playCDTrack(int track_num);
